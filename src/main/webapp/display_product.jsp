            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <form action="homes?action=search" method="post">
                            <input style="color: black" type="text" class="input" placeholder="Search here"
                                   name="keyword">
                            <button type="submit" style="color: rgb(68,157,68)" class="search-btn">Search</button>
                        </form>
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <c:forEach items="${students}" var="student" varStatus="index">
                    <tr>
                        ...
                        <td>
                            <a href="homes?action=update&&id_student=${student.getId()}" class="edit"
                               data-toggle="modal"><i class="material-icons"
                                                      data-toggle="tooltip"
                                                      title="Edit">&#xE254;</i></a>
                            <a onclick="deleteProduct(${student.getId()})"
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="homes?action=create" method="post">
...
<script>
    function deleteProduct(id) {
        ...
        if (flag === true) {
            window.location.href = "homes?action=delete&&id_student=" + id;
        }
    }
</script>
